  ...
  return (
    <div className="bg-surface text-on-surface min-h-screen">
      ...
      <main className="ml-64 p-8 min-h-screen">
        ...
        {/* Stats */}
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 mb-10 max-w-2xl">
          <div className="bg-white p-5 rounded-2xl border border-outline-variant/40 shadow-sm">
            <div className="flex items-center gap-2 mb-3">
              <div className="p-2 bg-secondary-fixed/60 text-secondary rounded-xl"><GraduationCap size={16} /></div>
          ...
          <div className="bg-white p-5 rounded-2xl border border-outline-variant/40 shadow-sm">
            <div className="flex items-center gap-2 mb-3">
              <div className="p-2 bg-secondary-fixed/60 text-secondary rounded-xl"><BarChart2 size={16} /></div>
          ...
          <div className="bg-white p-5 rounded-2xl border border-outline-variant/40 shadow-sm">
            <div className="flex items-center gap-2 mb-3">
              <div className="p-2 bg-secondary-fixed/60 text-secondary rounded-xl"><ShoppingBag size={16} /></div>
